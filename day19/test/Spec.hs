...
main = hspec $ do
  describe "foo" $ do
    ...
    it "testF" $ [(SS.fromList [1, 2, 3, 5, 6], 1), (SS.fromList [1, 2, 3, 6], 2), (SS.fromList [2, 3, 6], 2), (SS.fromList [3, 6], 0), (SS.fromList [3], 1)] `shouldBe` (unfoldr stealOne (SS.fromList [1 .. 6], 0))